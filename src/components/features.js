...
export default function Features() {
    return(
        <div className= 'flex flex-col items-center text-black font-semibold text-3xl m-16'>
            ...
            <div className='flex space-x-5 my-6 w-5/6 rounded-2xl shadow-lg p-8 bg-white'>
                ...
                <div>
                    ...
                    <p className='font-normal text-xl pt-4 pb-4 text-gray'>Add our custom logger to any Node.js application to quickly and easily send logs to Sherlogs.  Customize the log levels and messages you wish to receive.</p>
                    <a className='p-2 bg-main rounded-lg drop-shadow-lg text-white text-xl font-semibold hover:bg-white hover:text-main hover:border-2' href='https://www.quickloggerbe.com/' target='_blank' rel='noopener noreferrer'>Check out Quick Logger BE</a>
                </div>
            </div>
